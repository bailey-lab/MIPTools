...
these MIPs for genomic surveillance of Plasmodium falciparum targets, but we have
attempted to generalize this tool for other questions and datasets. This toolset
also assumes the use of unique molecular identifiers (UMIs) which tell us how
much of each type of DNA was originally present in each sample (prior to PCR
amplification).
...
.. toctree::
  ...
  guides/example_cross-sectional_study
  guides/probe-design
